		...
		<div id="list-docResource" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="file" title="${message(code: 'docResource.file.label', default: 'File')}" />
					
						<th><g:message code="docResource.createdBy.label" default="Created By" /></th>
				...
				<g:each in="${docResourceInstanceList}" status="i" var="docResourceInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: docResourceInstance, field: "file")}</td>
					
						<td>${fieldValue(bean: docResourceInstance, field: "createdBy")}</td>
